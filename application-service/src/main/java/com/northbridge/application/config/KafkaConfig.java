package com.northbridge.application.config;
...
/**
 * Kafka Configuration
 * Uses Spring Kafka JacksonJsonSerializer/JacksonJsonDeserializer and application-common event type.
 */
@Configuration
@EnableKafka
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, com.northbridge.common.events.ApplicationSubmittedEvent> producerFactory(tools.jackson.databind.json.JsonMapper mapper) {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        configProps.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        // VALUE_SERIALIZER_CLASS_CONFIG left for informational parity but we construct serializer with a mapper below
        ...
        return new DefaultKafkaProducerFactory<>(configProps, new org.apache.kafka.common.serialization.StringSerializer(), new JacksonJsonSerializer<com.northbridge.common.events.ApplicationSubmittedEvent>(mapper));
    }

    @Bean
    public KafkaTemplate<String, com.northbridge.common.events.ApplicationSubmittedEvent> kafkaTemplate(ProducerFactory<String, com.northbridge.common.events.ApplicationSubmittedEvent> producerFactory) {
